...
GWAS has successfully
identified many loci that are associated with various human diseases and
traits~\citep{locke2015,ishigaki2022,mahajan2022,yengo2022,mathieson2023},
and GWAS results are being actively incorporated into clinical
practice~\citep{visscher2017}.
Despite these successes, however, there are fundamental issues with
In spite of its advantages, population structure and
