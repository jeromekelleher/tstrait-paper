...
models~\citep{uffelmann2021}, adapted to the ARG context.
...
Every node in the local tree that inherits the causal allele
at that site is said to have a ``genetic value'' of $\beta$.
...
% TODO this is to be rewritten with just a single example from FC
% dataset and optionally also mentioning real data from 1000G (space
% permitting).
