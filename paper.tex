...
and producing large files when applied
...
To demonstrate its scalability we  applied \texttt{tstrait} to the
French-Canadian simulations~\cite{anderson2023} of chromosome 9
discussed in the introduction.
% TODO redo this for 100 causal sites @daiki.
It took 6 seconds and XXX GB of RAM to
simulate a trait with 100 causal sites using \texttt{tstrait}.
...
sites for the ARG estimated from chromosome 9 of the 1000 Genomes
project data~\citep{kelleher2019} which has YYY samples
